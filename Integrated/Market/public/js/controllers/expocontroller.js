        ...
        for (var i = 0; i < _data.length; i++) {
            if (_data[i]._id == _expoID) {
                ...
                for (var j = 0; j < _data[i].floors[0].Coordinates.length; j++) {
                    ...
                    div.innerHTML = '<div class="wow flipInX" data-wow-duration="2s" style="background-image:url(' + _data[i].floors[0].Coordinates[j].Img + ');position:absolute;top:' + top + 'px;left:' + left + 'px;height:' + height + 'px;width:' + width + 'px;background-size: cover;background-repeat: no-repeat;">\
